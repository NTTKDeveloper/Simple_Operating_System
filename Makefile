...
kernel.bin: 
	gcc -ffreestanding -fshort-wchar -c ./kernel/src/kernel.c -o ./kernel/src/kernel.o
	@ echo "!====== Linking"
	ld -T ./kernel/kernel.ld ./kernel/src/kernel.o --oformat binary -static -Bsymbolic -nostdlib -o ./kernel/kernel.bin
